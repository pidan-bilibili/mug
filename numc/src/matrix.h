...
typedef struct matrix {
    ...
    int reference; // 1 if matrix has child, 0 if not.
} matrix;
...
// int convert_to_base10_binary(int n);
int x_to_the_n (int x,int n);
//void transpose_matrix(matrix *m2_transpose, matrix *mat2);
// void transpose_blocking(int n, int blocksize, double *dst, double *src);